...
/// BUY POPUP
/// ======================
void showBuyPopup(BuildContext context, {required String symbol}) {
...
/// ======================
/// BUY ORDER FORM CONTENT
/// ======================
class _BuyOrderFormContent extends StatelessWidget {
  final OrderType orderType;

  const _BuyOrderFormContent({required this.orderType});
...
/// BUY SUBMIT BUTTON
/// ======================
class _BuySubmitButton extends StatelessWidget {
  final GlobalKey<FormBuilderState> formKey;

  const _BuySubmitButton({required this.formKey});
