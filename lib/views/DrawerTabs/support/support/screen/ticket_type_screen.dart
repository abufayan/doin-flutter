...
class _OpenTicketScreenState extends State<TicketTypeScreen> {
  ...
  final ticketTypes = const [
    ...
    (label: 'Withdrawal', icon: Icons.currency_exchange,  asset: 'moneyWithdrawl' ),
    (label: 'Refferal', icon: Icons.group, asset: 'employee'),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: selectedType == null
                    ? null
                    : () {
                        context.router.push(TicketCreateRoute(ticketType: '$selectedType'));
                      },
                child: const Text(
                  'Confirm',
                  style: TextStyle(
