...
final class AuthInitial extends AuthState {
   const AuthInitial() : super(const RegisterData());
}
...
final class PasswordResetSuccess extends AuthActionState {
  final String message;
  const PasswordResetSuccess(this.message, super.registerData);
}
...
final class OtpForgotPasswordError extends AuthActionState {
  final String message;
  final String email;

  const OtpForgotPasswordError(
      super.registerData, {
        required this.message,
        required this.email,
      });
...
final class OtpForgotPasswordSuccess extends AuthActionState {
  final String message;
  final String email;
  final bool navigateRequired;

  const OtpForgotPasswordSuccess(
      super.registerData, {
        required this.message,
        required this.email,
        this.navigateRequired = true,
      });
}
